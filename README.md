...
```
* Все тесты (Unit, Integration, Functional) будут прогнаны внутри контейнера. Тестовая база данных создается и настраивается автоматически при старте контейнеров.
...
| `noaccess@test.com` | `noaccess12345` | `ROLE_USER`  | Только публичные инвентари            |
